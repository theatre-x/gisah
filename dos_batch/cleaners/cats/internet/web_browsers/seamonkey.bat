...
cd .\Mozilla\SeaMonkey\Profiles\*.default\
...
del .\search.sqlite
echo [DONE]
echo Deleting URL Bar History ...

IF EXIST .\urlbarhistory.sqlite del .\urlbarhistory.sqlite
IF NOT EXIST .\urlbarhistory.sqlite echo NOT FOUND
...
IF NOT EXIST .\Cache echo NOT FOUND
